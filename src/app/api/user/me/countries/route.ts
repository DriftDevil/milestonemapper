...
export async function DELETE(request: NextRequest) {
    ...
    // The new backend endpoint for deleting all countries is `DELETE /user/me/countries`
    const url = new URL(`/user/me/countries`, EXTERNAL_API_URL).toString();
...
// POST handler for a single country has been moved to /api/user/me/countries/[countryId]/route.ts
