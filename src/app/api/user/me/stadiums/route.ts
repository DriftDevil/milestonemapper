...
const CONTEXT = "API User NFL Stadiums";
const EXTERNAL_API_URL = process.env.EXTERNAL_API_BASE_URL;

// GET handler to fetch visited stadiums
export async function GET(request: NextRequest) {
    ...
    const url = new URL('/user/me/stadiums', EXTERNAL_API_URL).toString();
...
// DELETE handler to remove all visited stadiums for a user
