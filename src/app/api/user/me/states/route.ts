...
const CONTEXT = "API User States";
const EXTERNAL_API_URL = process.env.EXTERNAL_API_BASE_URL;

// GET handler to fetch visited states
export async function GET(request: NextRequest) {
    ...
    const url = new URL('/user/me/states', EXTERNAL_API_URL).toString();
...
// DELETE handler to remove all visited states for a user
