...
const CONTEXT = "API User Ballparks";
const EXTERNAL_API_URL = process.env.EXTERNAL_API_BASE_URL;

// GET handler to fetch visited ballparks
export async function GET(request: NextRequest) {
    ...
    const url = new URL('/user/me/ballparks', EXTERNAL_API_URL).toString();
...
// DELETE handler to remove all visited ballparks for a user
